...
const RISK = {
  none:   { label:"Nominal",   color:"text-slate-400",   bg:"bg-slate-800/60",   border:"border-slate-600/40",  glow:"rgba(148,163,184,0)", peak:"rgba(148,163,184,0.22)", icon:<ShieldCheck size={12}/>,    pulse:false as const },
  low:    { label:"Low Risk",  color:"text-emerald-300", bg:"bg-emerald-950/60", border:"border-emerald-600/40", glow:"rgba(52,211,153,0)",  peak:"rgba(52,211,153,0.35)",  icon:<ShieldCheck size={12}/>,    pulse:false as const },
